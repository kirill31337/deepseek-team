...
HOOK_EVENTS = {
    ...
    'PreToolUse': '(?:.*[./])?(?:Read|Grep|Glob|Bash|exec_command|shell_command|Edit|Write|NotebookEdit|apply_patch|spawn_agent|send_message|send_input|followup_task|assign_agent_task|resume_agent|Agent|Task)',
    'Stop': None,
}
