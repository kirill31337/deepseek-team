...
class PolicyResolutionTests(RepoCase):
    ...
    def test_auto_instructions_are_adaptive_without_percentage_or_paid_exploration(self):
        ...
        self.assertIn('automatically selects bootstrap, adaptive or recovery', text)
        self.assertIn('up to three pending/running trials project-wide', text)
        self.assertIn('There is no manual stage switch', text)
